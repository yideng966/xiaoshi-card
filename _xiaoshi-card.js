console.info("%c 消逝集合卡 \n%c   v 2.6.6 ", "color: red; font-weight: bold; background: black", "color: white; font-weight: bold; background: dimgray");
...
class XiaoshiVideoCard extends HTMLElement {
  setConfig(config) {
    this.config = config;
  }
...
class XiaoshiImageCard extends HTMLElement {
  setConfig(config) {
    this.config = config;
  }
